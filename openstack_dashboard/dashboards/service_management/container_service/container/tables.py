...
#     subnet_template = 'docker_management/docker_monitor/docker_containers/_render_names.html'
#     context = {'names': container.names}
#     return template.loader.render_to_string(subnet_template, context)
#
#
# def get_ips(container):
#     subnet_template = 'docker_management/docker_monitor/docker_containers/_render_ips.html'
#     context = {'ips': container.ips}
#     return template.loader.render_to_string(subnet_template, context)
#
#
# def get_ports(container):
#     subnet_template = 'docker_management/docker_monitor/docker_containers/_render_ports.html'
...
class ContainerData:
    def __init__(self, container_id, names, state, status, ips, ports, host_name, image):
