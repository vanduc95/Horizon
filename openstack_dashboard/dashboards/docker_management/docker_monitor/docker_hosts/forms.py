...
class AddDockerHostForm(forms.SelfHandlingForm):
    ...
    def __init__(self, request, *args, **kwargs):
        super(AddDockerHostForm, self).__init__(request, *args, **kwargs)

    def clean(self):
        cleaned_data = super(AddDockerHostForm, self).clean()
    ...
    def get_success_url(self):
        return reverse("horizon:docker_management:docker_monitor:index")
